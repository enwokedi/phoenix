...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Copyright 2024 - :current_year, Phoenix World Rescue. Alle Rechte vorbehalten.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'email'                  => 'E-Mail',
                'footer-text'            => '© Copyright 2024 - :current_year, Webkul Software (eingetragen in Indien). Alle Rechte vorbehalten.',
                'locale'                 => 'Sprache',
